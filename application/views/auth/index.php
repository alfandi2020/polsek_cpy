...
<div class="container-xxl">
  <div class="authentication-wrapper authentication-basic container-p-y">
    <div class="authentication-inner">
      ...
      <div class="card">
        <div class="card-body">
        <a href="<?= base_url('dashboard') ?>" class="btn btn-warning"><i class='bx bx-chevron-left'></i> Back</a>
          ...
          <form id="formAuthentication" class="mb-3" method="POST" action="<?= base_url('auth');?>">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="username" autocomplete="off"
                value="<?= set_value('username');?>" placeholder="Masukkan nama Pengguna " />
          ...
          <a
            ...
            <i class='bx bxl-whatsapp'></i> 085945723077</a>
          <!-- </p> -->
          <br> <br>
          ...
          <span>
            <i class='bx bx-map'></i>
            Jl. Raya Mabes Hankam No.1, RT.4/RW.2, Bambu Apus, Kec. Cipayung, Kota Jakarta Timur, Daerah
