...
>
  <head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/css/datatables_responsive.bootstrap5.css') ?>">
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- Pages -->
            <li class="menu-header small text-uppercase">
              <span class="menu-header-text">Version 1.0</span>
            </li>
          </ul>
        </aside>
        <!-- / Menu -->
        ...
        <div class="layout-page">
          ...
          <nav class="navbar navbar-dark bg-light navbar-expand d-md-none d-lg-none d-xl-none fixed-bottom">
            <ul class="navbar-nav nav-justified w-100">
              ...
              <li class="nav-item">
                <a href="<?= base_url('dashboard/banner') ?>" class="nav-link"><i class='bx bx-images'></i> Banner</a>
              </li>
              <li class="nav-item">
