                        ...
                        <div class="col-md-2 col-xl-2 mb-5">
                          <div class="card h-100">
                            <img class="card-img-top" src="<?= base_url() ?>/assets/img/ceger.png"
                              alt="Card image cap" />
                            <div class="card-body">
                              <h5 class="card-title"><?= $x->kategori ?></h5>
                              <p class="card-text">Penduduk <?= $x->kategori ?>
                              </p>
                              <a href="<?= base_url('kelurahan/kriminal/'.$x->id_kriminal) ?>" class="btn btn-outline-primary">Detail</a>
                            </div>
                          </div>
                        </div>
                      <?php } ?>
